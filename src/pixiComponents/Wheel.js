...
export default PixiComponent('Wheel', {
    ...
    applyProps: (instance, oldP, newP) =>{
        ...
        for(let i = 0; i < itemCount; i++){
            ...
            const bottomAngle = currentDeg, topAngle = currentDeg + (360 / totalCount * dataArr[i].origCount)
            const itemLeft = dataArr[i].count > 0           // 獎項是否還有剩
            ...
            // 上面的文字
            const text = instance.addChild(new PIXI.Text(dataArr[i].name, textStyle))
